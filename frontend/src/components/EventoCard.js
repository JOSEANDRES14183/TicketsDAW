...
function EventoCard(props){
    ...
    return(
            <article aria-label={"Evento "+props.evento.titulo} className={"col-12 col-xl-6 mb-1 p-2 evento overflow-hidden"}>
                <div className={"rounded-25 h-100 shadow-sm position-relative"}>
                    ...
                    <div className={"row w-100 h-100"}>
                        ...
                        <div className={"col d-flex flex-column align-content-start p-3 h-100"}>
                            ...
                            <p aria-label={'categoria evento'} className={"text-secondary fw-bold"}>
                            ...
                            <p aria-label={'direccion'} className={"text-end text-primary h4 pe-3"}>
